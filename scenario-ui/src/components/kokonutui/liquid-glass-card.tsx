 ...
 *
 * Trimmed for this project: dropped the Next.js music-player demo (it
 * imported next/image, which doesn't exist outside a Next app) and kept
 * only the two reusable primitives, LiquidGlassCard and LiquidButton.
 */
