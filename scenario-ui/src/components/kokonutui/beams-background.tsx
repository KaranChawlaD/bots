 ...
 *
 * Trimmed for this project: the canvas beam animation is unchanged, but the
 * hardcoded "Beams Background" demo heading is gone in favor of `children`,
 * so this can sit behind the app's own content as a backdrop.
 */
